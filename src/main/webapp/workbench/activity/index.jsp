...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	$(function(){
			...
			if ($xz.length==0){
				...
				if (confirm("确定删除所选中的记录吗？")){
					...
					for (var i=0;i<$xz.length;i++){
						...
						//如果表示最后一个元素，需要在后面追加一个&符
						if (i<$xz.length-1){
							param += "&";
						}
					}
					//alert(param);//id=00ba985c15874a23a782246b3fe11b55&id=23beff82b114430ab75912b654b3e364
					$.ajax({
						url: "workbench/activity/delete.do",
						data: param,
						type: "post",
		...
		$("#editBtn").click(function () {
			...
			if ($xz.length==0){
				...
				var id = $xz.val();
				//alert(id)//b1c47a060396441090490b45e66470e3
	...
	/*
		...
		以上为pageList方法指定了六个入口，也就是说，在以上6给操作执行完毕后，我们必须调用pageList方法，刷新市场活动信息列表
	 */
			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody id="activityBody">
                        ...
                        <tr class="active">
                            <td><input type="checkbox" /></td>
                            <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/activity/detail.do.jsp';">发传单</a></td>
                            <td>zhangsan</td>
                            <td>2020-10-10</td>
                            <td>2020-10-20</td>
                        </tr>--%>
